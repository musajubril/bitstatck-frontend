...
export default function Hero({setForm, setOpen}) {
  return (
    <div className='flex lg:flex-row flex-col justify-between items-center mt-32 lg:mt-56'>
        <div className="flex flex-col lg:w-5/12 text-lightBlue-900">
            ...
            <div className="flex lg:flex-row flex-col justify-between mt-16">
                ...
                <button className="px-8 py-2 bg-yellow-500 hover:text-yellow-500 text-white hover:bg-white border border-yellow-500 rounded lg:w-60 w-full h-16 font-inter font-medium text-2xl" onClick={()=>{
