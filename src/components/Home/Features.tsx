        ...
        <div className="hidden md:flex w-full">
            ...
            <div className="flex flex-col justify-between">
                <div className="shadow-lg bg-white p-8 rounded-md flex justify-between">
                    <img src={require('../../images/bxs_user-check.png')} alt="" className="mr-9" />
                ...
                <div className="my-3">
                    <img src={require('../../images/100.png')} alt="" className=' h-14 object-center mx-auto' />
                </div>
                <div className="shadow-lg bg-white p-8 rounded-md flex justify-between">
                    <img src={require('../../images/bxs_user-check2.png')} alt="" className="mr-9" />
                    <div className="flex flex-col">
                ...
                <div className="shadow-lg bg-white p-8 rounded-md flex justify-between mb-44">
                    <img src={require('../../images/Frame 64.png')} alt="" className="mr-9" />
                    <div className="flex flex-col">
            ...
            <div className="flex h-full items-center justify-center mt-52 ml-3">
                <img src={require('../../images/102.png')} alt="" />
            </div>
            <div className=" mt-12 flex flex-col bg-white start_trading pt-20">
                <div className="">
                <img src={require('../../images/Frame 23.png')} alt="" className=' mx-auto' />
                </div>
