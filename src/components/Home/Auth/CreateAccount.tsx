...
export default function CreateAccount({form, setForm, open, setOpen, handleChange, handleConfirmPassword, confirmPasswordError, handleSubmit, userRegistration}) {
  ...
  return (
    <form onSubmit={handleSubmit} className=''>
          ...
          <div className="flex flex-col mb-7">
            ...
            <div className="relative flex-grow focus-within:z-10 flex items-center">
              <input
              required
              name="password"
              id="password"
              onChange={handleChange}
                type={passwordType}
                className="w-full md:w-m_f h-9 border border-gray-300 text-sm pl-3 font-normal rounded mt-1 focus:border-b focus-within:border-b"
                placeholder="*************"
              />
              {
                ...
                ?
                <EyeIcon
                  className="w-5 h-5 text-gray-600 cursor-pointer -ml-8"
                  aria-hidden="true"
            ...
            <PasswordStrengthBar password={userRegistration?.password} />
          </div>
          <div className="flex flex-col mb-7">
            <label
