      ...
      <div className={`${ open ? "fixed" : "hidden"} bg-opacity-60 bg-black min-h-screen w-screen top-0 flex justify-center items-center font-inter backdrop-blur-md`}>
        {
          ...
          <CreateAccount form={form} setForm={setForm} open={open} setOpen={setOpen} handleChange={handleRegistrationChange} handleConfirmPassword={handleConfirmPassword} confirmPasswordError={confirmPasswordError} handleSubmit={handleCreateAccount} userRegistration={userRegistration} />
          </div>
}
 {         
        form==="Login" && 
